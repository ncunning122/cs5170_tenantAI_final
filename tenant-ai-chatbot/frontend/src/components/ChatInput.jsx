...
// ChatInput component for capturing user messages in the chat
function ChatInput({ newMessage, isLoading, setNewMessage, submitNewMessage }) {

  // Using the auto-sizing hook to reference the textarea element
  const textareaRef = useAutosize(newMessage);

  // Handler for key down events in the textarea
